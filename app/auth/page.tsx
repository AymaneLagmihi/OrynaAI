...
export default function Login () {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-primary/10 via-background to-accent/10 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md backdrop-blur-sm bg-card/80 border-border/50 shadow-2xl animate-fade-in">
        <div className="p-8 space-y-6">
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full border-border/50 hover:bg-accent/10 transition-colors"
